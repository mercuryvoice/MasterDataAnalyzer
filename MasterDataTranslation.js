...
MasterData.TRANSLATIONS = {
    en: {
        ...
        businessTask4Step4Instruction: "Great, you should now see the generated chart report with multiple dimensions and metrics. You can choose your desired export format:<br>First, check the desired formats:<br><code>Add to Google Sheet tab</code><br><code>Export to Google Docs</code><br>Reminder: Choosing to export to a Google Sheet tab will create a new worksheet with the native chart and data for further editing. Exporting to Google Docs will present the report as an image.<br>Next, check the content you want to export, and then click <code>Confirm Export</code>.",
    ...
    'zh_TW': {
        ...
        businessTask4Step4Instruction: "太好了，這時您應可看到多維度與多指標的生成圖表報告了，您可選擇您想要的匯出格式：<br>首先，勾選想要匯出的格式：<br><code>新增至 Google Sheet 分頁</code><br><code>匯出至 Google 文件</code><br>提醒：選擇匯出 Google Sheet 分頁時將會新增一工作分頁並附上原生圖表的生成與數據可供您二次編輯，若選擇 Google 文件匯出方式將以圖片呈現。<br>再來，勾選您想要的匯出內容，接著再點擊 <code>確認匯出</code>",
