...
MasterData.TRANSLATIONS = {
    ...
    'zh_TW': {
        ...
        mfgTask2Step2Instruction: "在[資料驗證]設定視窗中，請進行以下設定：<br>1. **來源資料選擇**: 點擊「選取」按鈕，這會彈出一個檔案選擇視窗，請在視窗中選擇您當前的 Google 試算表檔案。<br>2. **來源資料分頁名稱**: 選擇 <code>{SOURCE_SHEET_NAME}</code><br>3. 請依照下列設定順序填妥資料範圍設定：<br>   - 資料驗證後匯入的起始列數請填入 <code>4</code><br>   - 目標資料標頭起始列請填入 <code>3</code><br>   - 來源資料標頭起始列請填入 <code>1</code><br><br>接下來繼續下一步，將開始設定 \"欄位驗證條件\" 與 \"驗證結果輸出\"。",
