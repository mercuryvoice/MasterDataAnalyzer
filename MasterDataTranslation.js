...
MasterData.TRANSLATIONS = {
    ...
    'zh_TW': {
        ...
        businessTask3Step2Instruction: "這次，請用 <code>產品名稱</code> 作為目標對比基準，並選擇 <code>[來源] 產品目標</code> 為來源分頁。<br>\"來源資料比對範圍\" 請設定為 <code>A2:B5</code>，\"資料比對欄位對應\" 請依照下方順序逐一設定：<br>  - **目標查找欄位**: <code>F</code> (產品名稱)<br>  - **來源比對欄位**: <code>A</code> (產品名稱)<br>  - **來源返回欄位**: <code>B</code> (目標月銷售額)<br>  - **目標寫入欄位**: <code>J</code> (目標月銷售額)",
