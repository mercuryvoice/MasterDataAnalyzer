...
<script>
    ...
    window.google = {
        script: {
            ...
            run: {
                ...
                report_getReportSettings: function(sheetName) {
                    const successCb = this._success;
                    // Simulate settings based on a global flag set by Playwright
        ...
        picker: {
            ...
            DocsView: class { setIncludeFolders() { return this; } },
            PickerBuilder: class {
...
with open("verification/mock_report_settings.html", "w") as f:
